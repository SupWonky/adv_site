...
INSERT INTO "new_FormField" ("formId", "id", "label", "name", "required", "type", "validationRules") SELECT "formId", "id", "label", "name", "required", coalesce("type", 'TEXT') AS "type", "validationRules" FROM "FormField";
