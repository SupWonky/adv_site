...
type ServiceWithImage = Service & { image: File | null };

export type ServiceNode = ServiceWithImage & { children: ServiceNode[] };

function buildTree(services: ServiceWithImage[]): ServiceNode[] {
