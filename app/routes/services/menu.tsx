...
export function MenuItem({ label, url, submenu, active, root }: MenuItemProps) {
  ...
  if (root) {
    return (
      <li>
        <Link
          className={cn(
            "flex justify-between items-center px-4 py-3 rounded-lg text-gray-700 hover:bg-muted",
